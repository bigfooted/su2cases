...
Plane Surface(4) = {4};
//+
Transfinite Curve {2, -4} = 1200 Using Progression 0.998;
Transfinite Curve {5, 7} =90 Using Progression 1;
Transfinite Curve {8, 10} = 750 Using Progression 1.0;
Transfinite Curve {11, -13} = 400 Using Progression 1.007;
//+
Transfinite Curve {1, 3} = 120 Using Bump 0.02;
Transfinite Curve {3, 6} = 120 Using Bump 0.02;
Transfinite Curve {6, 9} = 120 Using Bump 0.02;
Transfinite Curve {12} = 120 Using Bump 0.02;
//+
