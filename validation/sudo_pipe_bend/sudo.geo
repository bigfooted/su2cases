...
L_downstream = 15*D;
// coarse mesh
// cells in the flow direction of the bend
Nbend = 50;
// inner radius
L1=16;
...
Xs = 0.7 * X;
//+
// cross-sectional geometry: inner square
Point(1) = {-1.25*Xs, -Xs, 0, 1.0};
Point(2) = {+1.25*Xs, -Xs, 0, 1.0};
Point(3) = {+Xs, +Xs, 0, 1.0};
Point(4) = {-Xs, +Xs, 0, 1.0};
// center point
...
//+
Transfinite Curve {-14, 9, 12, 16} = L2 Using Progression 0.95;
//+
...
Extrude {0, 0, -L_upstream} {
  Surface{3}; Surface{4}; Surface{6}; Surface{2}; Layers{{20,20,60},{0.12,0.30,1}}; Recombine;
}
// make the bend 
...
Extrude {L_downstream, 0, 0} {
  Surface{26}; Surface{30}; Surface{33}; Surface{36}; Layers{{20,20,60},{0.12,0.30,1}}; Recombine;
}
//+
